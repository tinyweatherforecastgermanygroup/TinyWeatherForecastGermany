...
public ForecastAdapter(final Context context, final ArrayList<Weather.WeatherInfo> weatherForecasts, final ArrayList<Weather.WeatherInfo> weatherForecasts_hourly, final Weather.WeatherLocation weatherLocation) {
    ...
    this.display_bar = WeatherSettings.getDisplayBar(context);
    this.display_pressure = WeatherSettings.getDisplayPressure(context);
    this.display_visibility = WeatherSettings.getDisplayVisibility(context);
    this.display_sunrise = WeatherSettings.getDisplaySunrise(context);
    this.display_endofday_bar = WeatherSettings.getDisplayEndOfDayBar(context);
    this.display_gradient = WeatherSettings.getDisplayGradient(context);
    this.display_wind_type = WeatherSettings.getWindDisplayType(context);
    ...
    this.display_layout = WeatherSettings.getDisplayLayout(context);
    this.displaySimpleBar = WeatherSettings.getDisplaySimpleBar(context);
    this.display_wind_arc = WeatherSettings.displayWindArc(context);
    this.display_wind_arc_perdiod = WeatherSettings.getWindArcPeriod(context);
    this.warnings_disabled = WeatherSettings.getWarningsDisabled(context);
    this.viewModel = WeatherSettings.getViewModel(context);
